...
╚═╝░░╚══╝╚══════╝╚═╝░░░░░╚═╝░░╚═╝╚══════╝\u001b[31mv2
\033[1;37m----------------------------------------------
 AUTHOR     : SOMI JOIYA FUCK NIKHIL X HARRY
 GITHUB     : NIKHILBABE
 TOOL TYPE  : FILE MAKING
 VERSION    :\u001b[32m 2.3\033[1;37m
\033[1;37m----------------------------------------------
...
class login():
	...
	def login_WALA(self):
		...
		print(' [\u001b[36m2\033[1;37m] LOGIN WITH COOKIES   • NOT WORKING ')
		print(' [\u001b[36m0\033[1;37m] ENTER TO BACK ')
		linex()
...
def main_menu():
	...
	print(' [\u001b[36m1\033[1;37m] CREATE FILE SIMPLE ')
	print(' [\u001b[36m2\033[1;37m] CREATE FILE UNLIMITED ')
	print(' [\u001b[36m3\033[1;37m] REMOVE DUPLICATE IDz ')
	print(' [\u001b[36m4\033[1;37m] REPORT GLITCH ')
	print(' [\u001b[36m0\033[1;37m] LOGOUT')
	linex()
	xo = input(f' [{B}>>{W}] CHOOSE OPTION : ')
	if xo in ['01','1']:
	...
	if xo in ['00','0']:
		...
		linex()
		animation(f" [{B}×{W}] DONE LOGOUT + DELETE COOKIE ")
		exit()
	else:
		linex()
		animation(' [×] SELECT CORRECTLY ')
...
class file_create_menu():
	def file_simple(self):
		...
		if IOError:
			pass
			print(f' [{B}•{W}] PASTE UID ONE BY ONE ')
			linex()
			while True:
				ids_all = input(f" [{B}>{W}] ENTER UID : ")
				if ids_all == "":
					linex()
				...
				try:
					...
					if len(data) < 100:
						...
						try:
							...
							total_idss='-'
						print(f' [{B}•{W}] SUCESSFULLY EXTRACTED {uid} [{total_idss}] \033[0m')
						linex()
				except KeyError:
					pass
